...
class ipcChannel
{
    ...
    static log(...message)
	{
		if (Env.DEBUG_MODE) console.log('[', (ipcChannel.HIGHLIGHT ? kleur.bold().green : kleur.green)("contextBridge"), ']:', ...message);
	}
    static warn(...message)
	{
		if (Env.DEBUG_MODE) console.log('[', (ipcChannel.HIGHLIGHT ? kleur.bold().yellow : kleur.yellow)("contextBridge"), ']:', ...message);
	}
    static err(...message)
	{
		if (Env.DEBUG_MODE) console.log('[', (ipcChannel.HIGHLIGHT ? kleur.red().green : kleur.red)("contextBridge"), ']:', ...message);
	}
}
