...
class TabsManager
{
    ...
    static setTab(tabname, focus_tab = undefined)
    {
        ...
        if (TabsManager.tabs[tabname])
        {
            ...
            if (focus_tab !== null)
                (focus_tab || TabsManager.activeTab.tab).webContents.focus();
    ...
    static setNewTab(newTab, tabname = 'tab', update_modules = true, bounds = undefined, focus_tab = undefined)
    {
        return TabsManager.newTab(newTab, tabname, update_modules, bounds) && TabsManager.setTab(tabname, focus_tab);
    }
