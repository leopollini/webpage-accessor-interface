...
async function preload_extension(preload_dir, extension_name) {
	try {
		...
		if (typeof PreloadClass !== typeof function () {} || Object.getPrototypeOf(PreloadClass) !== BasePreload) {
			console.log(kleur.grey('Not loading ' + extension_name + ': not a module'));
			return;
		}
		...
		if (Env.DEBUG_MODE) console.log(extension_name, 'not preloaded', e);
	}
}
